...
describe "main command with string." do
  ...
  describe "returns opts and args when passing argv." do
    [
      {
        argv:        %w(),
        expect_opts: create_opts_hash({"string" => nil}),
      ...
      {
        argv:        %w(-s string1),
        expect_opts: create_opts_hash({"string" => "string1"}),
        expect_args: [] of String,
      },
      {
        argv:        %w(-sstring1),
      ...
      },
      {
        ...
        expect_opts: create_opts_hash({"string" => "tring"}),
        expect_args: [] of String,
      },
      {
...
describe "main command with string only short option." do
  ...
  describe "returns opts and args when passing argv." do
    [
      {
        argv:        %w(),
        expect_opts: create_opts_hash({"s" => nil}),
        expect_args: [] of String,
      },
      {
        argv:        %w(arg1),
      ...
      {
        argv:        %w(-s string1),
        expect_opts: create_opts_hash({"s" => "string1"}),
        expect_args: [] of String,
      },
      {
        argv:        %w(-sstring1),
      ...
      {
        argv:        %w(-string), # Unintended case.
        expect_opts: create_opts_hash({"s" => "tring"}),
        expect_args: [] of String,
      },
      {
        argv:        %w(-s=string1), # Unintended case.
...
class SpecMainCommandWithStringOnlyLongOption < Clim
  main_command
  desc "Main command with desc."
  usage "main_command with usage [options] [arguments]"
  string "--string=ARG"
...
describe "main command with string only long option." do
  describe "returns help." do
    [
      {
        argv: %w(--help),
      ...
      it "#{spec_case[:argv].join(" ")}" do
        run_proc_opts, run_proc_args = SpecMainCommandWithStringOnlyLongOption.run_proc_arguments(spec_case[:argv])
        run_proc_opts["help"].should eq(
          <<-HELP_MESSAGE
  ...
  describe "raises Exception when passing invalid argv." do
    [
      ...
      it "#{spec_case[:argv].join(" ")}" do
        expect_raises(Exception, spec_case[:exception_message]) do
          SpecMainCommandWithStringOnlyLongOption.run_proc_arguments(spec_case[:argv])
        end
      end
    end
  end
...
describe "main command with string default." do
  ...
  describe "returns opts and args when passing argv." do
    [
      {
        argv:        %w(),
        expect_opts: create_opts_hash({"string" => "default value"}),
        expect_args: [] of String,
      },
      {
        argv:        %w(arg1),
