...
{% end %}
#
# macro spec_for_sub_sub_commands(spec_class_name, spec_cases_hash)
#  {% for key, spec_case_hash in spec_cases_hash %}
#    {% for spec_case, index in spec_case_hash["spec_cases"] %}
...
#        main_command
#        run do |opts, args|
#          assert_opts_and_args({{spec_case_hash["help_message"]}}, {{spec_case}})
#        end
#
#        sub do
#          command "sub_command"
...
#        describe "if argv is " + {{spec_case["argv"].stringify}} + "," do
#          it_blocks({{class_name}}, {{spec_case}}, {{spec_case_hash["help_message"]}})
#        end
#      end
#    {% end %}
#  {% end %}
...
# macro spec_for_jump_over_sub_sub_command(spec_class_name, main_help_message, spec_cases_hash, sub_help_message = "", sub_sub_help_message = "")
#  {% for key, spec_case_hash in spec_cases_hash %}
